...
" Set visual mode highlight to black text on yellow background
hi Visual cterm=NONE ctermbg=yellow ctermfg=black guibg=yellow guifg=black
...
augroup languages
    ...
    autocmd FileType tf,hcl setlocal ts=4 sts=4 sw=4 expandtab autoindent
augroup END
